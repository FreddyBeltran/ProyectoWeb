...
console.log("stringLocalProject:");
console.log(string);
...
console.log(movieId);
console.log("STRING HARDCODEADO:");
...
const data = async () =>
{
  ...
  console.log("AQUI ESTAMOS TRABAJANDO");
  console.log(data);
};
*/

const data = fetch(`https://api.themoviedb.org/3/movie/${movieId}?api_key=41ee980e4b5f05f6693fda00eb7c4fd4`).then((response) => response.json()).then((jsonValues) =>
  {
    console.log("ESTE ES UN NUEVO LOG");
    console.log(jsonValues.overview);
    //titleName = jsonValues.original_title;
    //let data = jsonValues;

    let titleName = jsonValues.original_title;
    let imageUrl = IMG_PATH + jsonValues.poster_path;
    let descriptionDetails = jsonValues.overview;
    let dateFormat = jsonValues.release_date;
    ...
    imageElement.style.borderRadius = '3em';
...
console.log("AQUI DEBERIA DE SER");
console.log(data);

console.log("AQUI DEBERIA SER LA FUNCION");
